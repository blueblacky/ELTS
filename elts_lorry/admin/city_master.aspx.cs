...
public partial class city_master : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string sql = "INSERT INTO city_master(city_name,state_master_id,status)VALUES(@P0,@P1,@p2)";
    ...
    protected void UpdateCity(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            string sql = "UPDATE city_master SET city_name=@P0,state_master_id=@P1 WHERE city_id=@p2";
            ...
            Response.Redirect("http://localhost/elts_lorry/admin/city_master");
        }
        catch (Exception ee)
        {
