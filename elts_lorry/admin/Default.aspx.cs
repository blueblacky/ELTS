...
public partial class admin_Default : System.Web.UI.Page
{
    ...
    protected void btn_login_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            txtCaptcha.Text = ""; 
            lbl_capt_wrong.Text = "Incorrect Captcha";
        }
        ...
        {                      
            try
            {
                ...
                if (query != null)
                {
                    Session["u_id"] = query.Id.ToString();
                    Session["u_name"] = query.UName.ToString();
                    Response.Redirect("http://localhost/elts_lorry/admin/state_master");
                }
                else
                {
                    lbl_capt_wrong.Text = "<br/>Username or Password is wrong";
                }
            }
            catch (Exception e2)
            {
